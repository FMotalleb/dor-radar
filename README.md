...
[![Go Reference](https://pkg.go.dev/badge/github.com/fmotalleb/dor-radar.svg)](https://pkg.go.dev/github.com/fmotalleb/dor-radar)
[![go.mod](https://img.shields.io/github/go-mod/go-version/fmotalleb/dor-radar)](go.mod)
[![LICENSE](https://img.shields.io/github/license/fmotalleb/dor-radar)](LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/fmotalleb/dor-radar)](https://goreportcard.com/report/github.com/fmotalleb/dor-radar)
[![Codecov](https://codecov.io/gh/fmotalleb/dor-radar/branch/main/graph/badge.svg)](https://codecov.io/gh/fmotalleb/dor-radar)
...
1. Replace all occurrences of `fmotalleb/dor-radar` to `your_org/repo_name` in all files.
